#
# Module manifest for module 'PsAdp'
#
...
GUID = '35322b4b-bab1-47b3-b74c-187c1cc47c2a'
...
FunctionsToExport = @('Get-AdpAccessToken')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('powershell','pwsh','adp','api')

        # A URL to the license for this module.
        # LicenseUri = ''

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/craibuc/PsAdp'
